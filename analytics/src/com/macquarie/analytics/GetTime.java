...
public class GetTime {
	   ...
	   */
	  static GaData executeTimeDataQuery(Analytics analytics, String tableId, String startDate, String endDate, String url) throws IOException {
			  ...
			  return analytics.data().ga().get(tableId, // Table Id.
			        ...
			        .setDimensions("ga:hour, ga:pagePath")
