...
public class GetDevices {
	   ...
	   */
	  static GaData executeDevicesDataQuery(Analytics analytics, String tableId, String startDate, String endDate, String url) throws IOException {
			  ...
			  return analytics.data().ga().get(tableId, // Table Id.
			        ...
			        .setDimensions("ga:deviceCategory, ga:pagePath")
