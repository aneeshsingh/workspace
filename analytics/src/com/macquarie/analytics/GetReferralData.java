...
public class GetReferralData {
	   ...
	   */
	  static GaData executeReferralDataQuery(Analytics analytics, String tableId, String startDate, String endDate, String url) throws IOException {
			  ...
			  return analytics.data().ga().get(tableId, // Table Id.
			        ...
			        .setDimensions("ga:pagePath,ga:sourceMedium")
