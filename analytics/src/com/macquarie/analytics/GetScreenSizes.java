...
public class GetScreenSizes {
	   ...
	   */
	  static GaData executeScreenSizesDataQuery(Analytics analytics, String tableId, String startDate, String endDate, String url) throws IOException {
	    

			  return analytics.data().ga().get(tableId, // Table Id.
			    		startDate, // Start date.
			    		endDate, // End date.
			        "ga:pageviews,ga:avgTimeOnPage") // Metrics.
			        .setDimensions("ga:screenResolution,ga:pagePath")
