...
public class GetReturningNew {
	   ...
	   */
	  static GaData executeReturnNewDataQuery(Analytics analytics, String tableId, String startDate, String endDate, String url) throws IOException {
			  ...
			  return analytics.data().ga().get(tableId, // Table Id.
			        ...
			        .setDimensions("ga:userType, ga:pagePath")
